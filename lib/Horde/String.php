...
class Horde_String
{
     ...
     * @param string $to     See self::convertCharset().
     *
     * @return string|false  The converted string, or false on error.
     */
    protected static function _convertCharsetIconv(string $input, string $from, string $to): string|false
    {
        error_clear_last();
